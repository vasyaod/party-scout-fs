...
| **Stern Grove Festival (venue/series)** | https://www.sterngrove.org/lineup2026 | L + P | Music | common | **Free** Sunday-afternoon concert series at Sigmund Stern Grove (19th Ave & Sloat Blvd), mid-June→mid-Aug. Big cross-genre marquee names (indie, soul, symphony, some electronic). `/lineup2026` = full season (date + headliner); **JS-rendered → read via `common`** (plain HTTP returns only nav). Price = **Free** (GA lottery, no ticket cost). |
